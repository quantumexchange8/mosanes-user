...
<template>
    <div class="flex flex-col items-center gap-3 self-stretch pb-4 border-b border-gray-200">
        ...
        <div class="flex items-center gap-1 self-stretch">
            ...
            <span class="flex-grow text-gray-950 text-sm font-medium">{{ data.transaction_type === 'deposit' ? data.to_meta_login : data.from_meta_login }}</span>
        </div>
        <div class="flex items-center gap-1 self-stretch">
